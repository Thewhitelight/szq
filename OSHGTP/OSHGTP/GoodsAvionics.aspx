<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsAvionics.aspx.cs" Inherits="OSHGTP.GoodsAvionics" %>

<%@ Register Src="~/Control/Header.ascx" TagPrefix="uc1" TagName="Header" %>
<%@ Register Src="~/Control/LeftProduct.ascx" TagPrefix="uc1" TagName="LeftProduct" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="zuo">
                <uc1:LeftProduct runat="server" ID="LeftProduct" />
            </div>
            <div class="zhong">
