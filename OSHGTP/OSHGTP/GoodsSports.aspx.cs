...
namespace OSHGTP
{
    public partial class GoodsSports : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GetGoods = MarketBase.DisPlayList_Ds("select GName,GId,GBSD from tb_Goods where GTypeId='3' order by GSDate desc", conn);
