...
namespace OSHGTP
{
    public partial class UserGoodsDetail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GetGoods = MarketBase.DisPlayList_Ds("select GName,GId,GBSD from tb_Goods,tb_UserInfo where tb_Goods.UId=tb_UserInfo.UId and UName='"+Session["UName"].ToString()+"'order by GSDate desc", conn);
