...
namespace OSHGTP
{
    public partial class GoodsBooks : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            GetGoods = MarketBase.DisPlayList_Ds("select GName,GId,GBSD from tb_Goods where GTypeId='1' order by GSDate desc", conn);
